...
class AdminFrame(tk.Frame):
    def __init__(self, parent: tk.Frame, controller: tk.Tk):
        ...
        userBtn = tk.Button(headFrame, text="User Management", font=(FONT_FAM, FONT_SIZE), padx=10, pady=5, background=S_COL, foreground=TXT_COL, relief=tk.FLAT, bd=0, width=25)
        userBtn.pack(padx=15, pady=15, anchor=tk.W)
        userBtn.bind('<Enter>', controller.hoverBtn)
        userBtn.bind('<Leave>', controller.unhoverBtn)
    
        questBtn = tk.Button(headFrame, text="Quiz Question Management", font=(FONT_FAM, FONT_SIZE), padx=10, pady=5, background=S_COL, foreground=TXT_COL, relief=tk.FLAT, bd=0, width=25)
        ...
        logoutBtn = tk.Button(headFrame, text="Logout Quiz App", font=(FONT_FAM, FONT_SIZE), padx=10, pady=5, background=S_COL, foreground=TXT_COL, relief=tk.FLAT, bd=0, width=25) 
